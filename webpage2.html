...
<body>
  ...
  <hr>
    <h1 id="scorecard">Institution-Level Data</h1>
    ...
    <a href="pep_roi.csv" download class="download-button">Download Dataset</a>

  <hr>
    <h1 id="scorecard">Third Way's Price to Earnings Premium (PEP) Model</h1>
    ...
    <div id="table"></div>
    <h1> Further Analysis of the PEP Model</h1>
    ...
    <h1>Postsecondary Value Commission ROI Frameworks</h1>
    <p>
    ...
    <h1 id="threshold0">Postsecondary Value Commission: Threshold 0</h1>
    <section id="threshold1-framework">
      ...
      <h2>Table of Results and Relevant Variables</h2>
    </section>
    ...
    <img
        src="threshold0logoddsmsitype.png"
    ...
    <img
        src="threshold0logoddsdemographic.png"
    ...
    <hr>
    <h1 id="threshold1">Postsecondary Value Commission: Threshold 1</h1>
    ...
    <hr>
    <h1 id="threshold0">Postsecondary Value Commission: Threshold 2</h1>
    ...
    <div id="table-threshold2"></div>
    <h2>Regression Models</h2>

    <hr>
    <h1 id="conclusions">Overall Takeaways</h1>
    <p>
